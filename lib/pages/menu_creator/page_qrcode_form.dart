...
class _PageQrcodeFormState extends State<PageQrcodeForm> {
  ...
  late String Function(Map<String, dynamic> valueMap) decodeValueFunc;
          ...
          IconButton(
            ...
            onPressed: () {
              if (_formKey.currentState?.saveAndValidate() ?? false) {
                ...
                final String contents = decodeValueFunc(valueMap);
                _sendForm(contents);
              }
            },
          )
            ...
            children: [
              ...
              FormBuilder(
                ...
                child: _TypeSwitchForm(
                  ...
                  decodeValueFuncChange: (func) => decodeValueFunc = func,
                  formKey: _formKey,
                  sendForm: _sendForm,
                ),
              ),
...
class _TypeSwitchForm extends StatefulWidget {
  ...
  final ValueChanged<String Function(Map<String, dynamic>)> decodeValueFuncChange;
  final GlobalKey<FormBuilderState> formKey;
  final ValueChanged<String> sendForm;

  const _TypeSwitchForm({
    required this.historyType,
    required this.decodeValueFuncChange,
  ...
  State<_TypeSwitchForm> createState() {
    final _FormState widgetState = switch (historyType) {
      .text => _FormTextState(),
      .website => _FormWebsiteState(),
      .contact => _FormContactState(),
      .mail => _FormMailState(),
      .sms => _FormSmsState(),
      .phone => _FormPhoneState(),
      .location => _FormLocationState(),
      .event => _FormEventState(),
      .wifi => _FormWifiState(),
      _ => _FormUnsupportedState(),
    };
    decodeValueFuncChange(widgetState._decodeValue);
    return widgetState;
  }
}

abstract class _FormState extends State<_TypeSwitchForm> {
  String _decodeValue(Map<String, dynamic> valueMap);
}

class _FormUnsupportedState extends _FormState {
  @override
  String _decodeValue(Map<String, dynamic> valueMap) {
...
class _FormTextState extends _FormState {
  @override
  String _decodeValue(Map<String, dynamic> valueMap) {
...
class _FormWebsiteState extends _FormState {
  @override
  String _decodeValue(Map<String, dynamic> valueMap) {
  ...
  Widget build(BuildContext context) {
    return FormBuilderTextField(
      ...
      onEditingComplete: () {
        widget.formKey.currentState?.fields['website']?.validate();
      },
    );
  }
}

class _FormContactState extends _FormState {
  final List<String> _contactMailType = <String>['home', 'home', 'home'];
  final List<String> _contactPhoneType = <String>['cell', 'cell', 'cell'];
...
class _FormMailState extends _FormState {
  @override
  String _decodeValue(Map<String, dynamic> valueMap) {
    ...
    return Column(
      children: [
        FormBuilderTextField(
          ...
          onEditingComplete: () {
            widget.formKey.currentState?.fields['email']?.validate();
          },
        ),
        const SizedBox(height: 16),
        FormBuilderTextField(
...
class _FormSmsState extends _FormState {
  @override
  String _decodeValue(Map<String, dynamic> valueMap) {
    ...
    return Column(
      children: [
        FormBuilderTextField(
          ...
          onEditingComplete: () {
            widget.formKey.currentState?.fields['phone']?.validate();
          },
        ),
        const SizedBox(height: 16),
        FormBuilderTextField(
          ...
          onEditingComplete: () {
            widget.formKey.currentState?.fields['message']?.validate();
          },
        ),
      ],
    );
...
class _FormPhoneState extends _FormState {
  @override
  String _decodeValue(Map<String, dynamic> valueMap) {
...
class _FormLocationState extends _FormState {
  @override
  String _decodeValue(Map<String, dynamic> valueMap) {
    ...
    return Column(
      children: [
        FormBuilderTextField(
          ...
          onEditingComplete: () {
            widget.formKey.currentState?.fields['latitude']?.validate();
          },
        ),
        const SizedBox(height: 16),
        FormBuilderTextField(
          ...
          onEditingComplete: () {
            widget.formKey.currentState?.fields['longitude']?.validate();
          },
        ),
        const SizedBox(height: 16),
        FormBuilderTextField(
          ...
          onEditingComplete: () {
            widget.formKey.currentState?.fields['height']?.validate();
          },
        ),
        const SizedBox(height: 16),
        FormBuilderTextField(
...
class _FormEventState extends _FormState {
  bool _eventAllDay = false;
  ...
  String _decodeValue(Map<String, dynamic> valueMap) {
    ...
    if (beginDate == null || endDate == null) throw 'beginDate == null || endDate == null';
    ...
    return Column(
      ...
      children: [
        FormBuilderTextField(
          ...
          onEditingComplete: () {
            widget.formKey.currentState?.fields['summary']?.validate();
          },
        ),
        FormBuilderCheckbox(
          name: 'allday',
...
class _FormWifiState extends _FormState {
  String _wifiSecurityType = 'SAE';
    ...
    return Column(
      children: [
        FormBuilderTextField(
          ...
          onEditingComplete: () {
            widget.formKey.currentState?.fields['ssid']?.validate();
          },
        ),
        const SizedBox(height: 16),
        DropdownMenu(
        ...
        if (_wifiSecurityType != 'nopass') FormBuilderTextField(
          ...
          onEditingComplete: () {
            widget.formKey.currentState?.fields['password']?.validate();
          },
        ),
        FormBuilderCheckbox(
          name: 'hide',
