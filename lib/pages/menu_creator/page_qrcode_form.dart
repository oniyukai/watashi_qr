...
class _PageQrcodeFormState extends State<PageQrcodeForm> {
  ...
  late final _FormState _formState = switch (_historyType) {
    HistoryType.text => _StateText(),
    HistoryType.website => _StateWebsite(),
    HistoryType.contact => _StateContact(),
    HistoryType.mail => _StateMail(),
    HistoryType.sms => _StateSms(),
    HistoryType.phone => _StatePhone(),
    HistoryType.location => _StateLocation(),
    HistoryType.event => _StateEvent(),
    HistoryType.wifi => _StateWifi(),
        ...
        child: Scrollbar(
          child: ListView(
            ...
            children: [
              ...
              FormBuilder(
                key: _formKey,
                child: StatefulBuilder(builder: _formState.build),
              ),
            ],
          ),
        ),
...
class _StateText extends _FormState {
  ...
  @override
  Widget build(BuildContext context, StateSetter setState) {
    return BarcodeField(format: HistoryFormat.qrCode, name: 'text');
  }
}
              ...
              Expanded(
                ...
                child: DropdownMenu(
                  ...
                  dropdownMenuEntries: [
                    DropdownMenuEntry(
                      value: 'home',
                      label: DictKey.creatorContactOptionHome.s,
                    ),
                    DropdownMenuEntry(
                      value: 'work',
                      label: DictKey.creatorContactOptionWork.s,
                    ),
                    DropdownMenuEntry(
                      value: 'other',
                      label: DictKey.creatorContactOptionOther.s,
                    ),
                  ],
                  onSelected: (value) {
              ...
              Expanded(
                ...
                child: DropdownMenu(
                  ...
                  dropdownMenuEntries: [
                    DropdownMenuEntry(
                      value: 'cell',
                      label: DictKey.creatorContactOptionMobile.s,
                    ),
                    DropdownMenuEntry(
                      value: 'home',
                      label: DictKey.creatorContactOptionHome.s,
                    ...
                    DropdownMenuEntry(
                      value: 'fax',
                      label: DictKey.creatorContactOptionFax.s,
                    ),
                    DropdownMenuEntry(
                      value: 'other',
                      label: DictKey.creatorContactOptionOther.s,
        ...
        FormBuilderTextField(
          ...
          validator: FormBuilderValidators.compose([
            ...
            FormBuilderValidators.phoneNumber(
              errorText: DictKey.errorPhoneNumber.s,
            ),
          ]),
        ),
        FormBuilderTextField(
    ...
    return Column(
      ...
      children: [
        ...
        FormBuilderTextField(
          name: 'request',
          keyboardType: TextInputType.text,
          decoration: InputDecoration(labelText: DictKey.creatorGeoHintQuery.s),
        ),
      ],
    );
  }
...
class _StateEvent extends _FormState {
  ...
  String valueDecode(Map<String, dynamic> valueMap) {
    ...
    final DateFormat dateFormat = DateFormat(
      _isAllDay ? "';VALUE=DATE:'yyyyMMdd" : "':'yyyyMMdd'T'HHmm00'Z'",
    );
...
class _StateWifi extends _FormState {
  ...
  String valueDecode(Map<String, dynamic> valueMap) {
    ...
    final String password = _securityType != 'nopass'
        ? valueMap['password']
        : '';
      ...
      children: [
        ...
        DropdownMenu(
          ...
          dropdownMenuEntries: [
            DropdownMenuEntry(
              value: 'WEP',
              label: DictKey.creatorWifiEncryptionWep.s,
            ),
            DropdownMenuEntry(
              value: 'WPA',
              label: DictKey.creatorWifiEncryptionWpa.s,
            ),
            DropdownMenuEntry(
              value: 'SAE',
              label: DictKey.creatorWifiEncryptionSae.s,
            ),
            DropdownMenuEntry(
              value: 'nopass',
              label: DictKey.creatorWifiEncryptionNone.s,
            ),
          ],
          onSelected: (value) {
