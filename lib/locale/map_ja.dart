...
const LocaleInstance mapJa = {
  ...
  K.customSearchUrlsAddInfo: 'URLで「${StaticString.searchReplaceWord}」という用語を使用します。 この用語は、検索中にバーコードの内容に置き換えられます。',
  K.examples: '例：',
  K.customSearchUrlsErrorUrl: 'URLに「${StaticString.searchReplaceWord}」という用語が含まれている必要があります。',
