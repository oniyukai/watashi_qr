...
const LocaleInstance mapZhHans = {
  ...
  K.customSearchUrlsAddInfo: '在网址中使用术语"${StaticString.searchReplaceWord}"。该术语将会在搜索过程中被条码的内容取代。',
  K.examples: '例子: ',
  K.customSearchUrlsErrorUrl: '网址中必须包含术语: ${StaticString.searchReplaceWord}',
