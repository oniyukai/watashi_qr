...
const LocaleInstance mapZhHant = {
  ...
  K.customSearchUrlsAddInfo: '在網址中使用術語"${StaticString.searchReplaceWord}"。該術語將會在搜尋過程中被條碼的內容取代。',
  K.examples: '例子: ',
  K.customSearchUrlsErrorUrl: '網址中必須包含術語: ${StaticString.searchReplaceWord}',
